...
from tensorflow.keras.layers import BatchNormalization, RandomCrop, RandomFlip, Rescaling
...
def BuildCNNMLPModel() -> cnn_mlp.CNNMLP:
    ...
    result = cnn_mlp.CNNMLP(inputs = inputs, outputs = mlp_predictor, name ="cnn_mlp")
    return result
